...
import { Activity, AlignJustify, ArrowUp, BarChart3, CalendarDays, Check, ChevronLeft, ChevronRight, CircleDot, Clock3, Copy, Download, Dumbbell, ExternalLink, Flame, Footprints, HeartPulse, History, Link2, Pencil, Plus, RotateCcw, Share2, Sparkles, Trash2, Trophy, X } from 'lucide-react'
...
const PartIcon = ({part}: {part: Part}) => part === '胸' ? <HeartPulse/> : part === '肩' ? <ArrowUp/> : part === '背' ? <AlignJustify/> : part === '腿' ? <Footprints/> : part === '核心' ? <CircleDot/> : <Activity/>
